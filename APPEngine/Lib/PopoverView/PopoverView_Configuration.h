...
#define kGradientBottomColor [UIColor colorWithWhite:0 alpha:0.8]

//top color white value in gradient bg
//#define kGradientTopColor [UIColor colorWithRed:1.f green:1.f blue:1.f alpha:kBoxAlpha]
#define kGradientTopColor [UIColor colorWithWhite:0 alpha:0.8]
...
#define kTextColor [UIColor colorWithWhite:1 alpha:1]
